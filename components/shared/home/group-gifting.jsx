  ...
  return (
    <section className="py-8 md:py-14 px-4 md:px-6 bg-[#FFFAEB] section-lazy">
      <div className="max-w-[1280px] mx-auto">
        <div
          data-reveal
          className="reveal rounded-3xl overflow-hidden flex flex-col md:flex-row"
          style={{
            background: "#FFFFFF",
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center px-7 py-8 md:px-10 md:py-12 bg-[#FFFAEB]">
            ...
            >
              ...
              <span className="inline-flex items-center group-hover:translate-x-1 transition-transform">
                ...
                >
                  <line x1="0" y1="6" x2="30" y2="6" stroke="currentColor" strokeWidth="1.5" />
                  <path
                    d="M25 1L31 6L25 11"
                    stroke="currentColor"
                    strokeWidth="1.5"
          ...
          <div
            data-reveal
            className="reveal reveal-d-100 md:w-[45%] flex items-end justify-center overflow-hidden min-h-55 md:min-h-85 rounded-2xl"
          ...
          >
            <Image
              ...
              width={600}
              height={340}
              className="w-[70%] md:w-full h-auto object-contain block mx-auto"
            />
          </div>
        </div>
      </div>
