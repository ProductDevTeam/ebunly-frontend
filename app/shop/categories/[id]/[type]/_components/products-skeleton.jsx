export default function ProductsSkeleton() {
  return (
    <div className="w-full max-w-300 mx-auto px-4 xl:px-0 pb-10 md:pb-16">
      {/* Mobile rails */}
      ...
      <div className="flex md:gap-20">
        {/* Sidebar */}
        <div className="hidden md:block w-50 shrink-0 pt-1">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <div className="skeleton h-10 w-39.25 rounded-full" />
